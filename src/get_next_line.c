...
/*   Updated: 2017/12/06 20:01:33 by emarin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_list	*ft_freelst(int fd, t_list *lstfd)
{
	t_list	*last;
	t_list	*top;
...
int		ft_read(int fd, t_list **lstfd, int first, int *aswrite)
{
	int		nb;
	char	*buff;
...
int		ft_pushbuff(char **l, int first, t_list *lstfd)
{
	int		i;
	char	*buff;
	char	*realc;
...
int		ft_loop(t_list **lstfd, const int fd, char **line, int nbwr[3])
{
	int		rval;
	t_list	*res;
	int		useless;
